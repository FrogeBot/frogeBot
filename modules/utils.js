                ...
                let attachmentMessages = messages
                    .map((message) => {
                        ...
                        if (message.attachments.first()) {
                            attachmentURL = message.attachments.first()
                                .proxyURL; // If message has image attachment set as URL
                        } else {
                            if (
                                message.embeds[0] &&
                            ...
                            if (
                                ...
                                attachmentURL =
                                    ...
                                    (message.embeds[0].url.match(/(\.gif)/gi)
                                        ? ''
                                        : '.gif'); // If message has gifv embed set as URL (Ensuring it ends with .gif)
                            }
                            if (
                                message.embeds[0] &&
